...
public class KnuthMorrisPrattAlgorithmSlowAlgorithm extends AbstractAlgorithmTest {
	@Override
	protected void executeTest(TestData testData) {
		final KnuthMorrisPrattAlgorithm algorithm = new KnuthMorrisPrattAlgorithm(PiFunction.slowAlgorithm());
